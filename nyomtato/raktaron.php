...
// Egyszerű lekérdezés (szükség esetén tehetsz rendezést / keresést)
...
?>
  ...
  <div class="container page-container my-4">
    <div class="d-flex justify-content-between align-items-start mb-3">
      <div>
        <h1 class="h3 mb-1">Nyomtató raktár</h1>
      </div>
            ...
            <tbody>
              <?php foreach ($rows as $r): ?>
                <tr>
                  ...
                  <td>
                    <?php if ($r['raktaron'] == 1): ?>
                            <span class="badge bg-success rounded-pill px-3 py-2">Raktáron</span>
                    <?php else: ?>
                            <span class="badge bg-danger rounded-pill px-3 py-2">Nincs</span>
                    <?php endif; ?>
                </td>
